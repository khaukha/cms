<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style11">
            ...
            <td><select name="filter_inst_id" id="filter_inst_id" size=7 class="style11" style="width:100%;" onChange="doPost();"><%=Html.selectOptionsX(dao.getShippingDao().getList(false),sc.inst_id,"All")%></select></td>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
                  <tr align="center" bgcolor="#DDDDDD">
                    ...
                    <th width="90"  rowspan="3">Sales Ref</th>
...
<%
	//List<WnAllocationEntity> wns = task.getQrExport().search(sc);
	sc.setFilterMonth();
	PagingView<WnExportEntity> _paging = dao.getWnExportDao().getPaging();	
...
%>				
                <tr align="right" onClick="rowClicked(this,<%=qr.getIdLong()%>)" onDblClick="setValue('view',1);doTask();" bgcolor="#FFFFFF">
                  ...
                  <td width="90" align="left"><%=wn.getShipping().getContract().getShortRef()%></td>
                  ...
                  <td width="70"><%=Numeric.numberToStr(wn.net_weight/1000,3)%>&nbsp;</td>                  				  
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
              <tr bgcolor="#DDDDDD" align="right" class="style11" style="font-weight:bold; color:#000000">
                <td width="678" align="center">Estimated Total in %</td>
			  	<td width="70"><%=Numeric.numberToStr(sum.net_weight/1000,3)%>&nbsp;</td>
