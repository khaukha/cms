<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style11">
            ...
            <td><select name="filter_inst_id" id="filter_inst_id" size=7 class="style11" style="width:100%;" onChange="doPost();"><%=Html.selectOptionsX(dao.getDeliveryDao().getList(false),sc.filter_inst_id,"All")%></select></td>
...
%>				
                <tr align="right" onClick="rowClicked(this,<%=qr.getIdLong()%>)" onDblClick="setValue('view',1);doTask();" bgcolor="#FFFFFF">
                  ...
                  <td width="120" align="left"><%=wn.getInstruction().getContract().getSeller().short_name%></td>
				  <td width="42" align="left"><%=qr.getInspector().short_name%></td>
                  ...
                  <td width="60"><%=Numeric.numberToStr(wn.net_weight,0)%>&nbsp;</td>                  				  
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
              <tr bgcolor="#DDDDDD" align="right" class="style11" style="font-weight:bold; color:#000000">
                <td width="690" align="center">Estimated Total in %</td>
