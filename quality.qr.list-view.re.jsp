<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11">
            ...
            <td><select name="ifilter_nst_id" id="filter_inst_id" size=7 class="style11" style="width:100%;" onChange="doPost();"><%=Html.selectOptionsX(dao.getTruckingDao().getList(false),sc.filter_inst_id,"All")%></select></td>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
                  <tr align="center" bgcolor="#DDDDDD">
                    ...
                    <th width="90"  rowspan="3">Trucking Ref</th>
                    <th width="30"  rowspan="3">Insp.</th>
...
<div id="qr_list_view" style="overflow:scroll; height:250px; width:100%">
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
              <tr bgcolor="#DDDDDD" align="right" class="style11" style="font-weight:bold; color:#000000">
                <td width="689" align="center">Estimated Total in %</td>
