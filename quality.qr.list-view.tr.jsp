<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11">
            ...
            <td><select name="filter_inst_id" id="filter_inst_id" size=7 class="style11" style="width:100%;" onChange="doPost();"><%=Html.selectOptionsX(dao.getTruckingDao().getList(false),sc.filter_inst_id,"All")%></select></td>
            <td><select name="filter_quality_id" id="filter_quality_id" size=7 class="style11" style="width:100%;" onChange="setValue('grade_id',0);doPost();"><%=Html.selectOptions(dao.getQualityDao().selectAll(),sc.filter_quality_id,"All")%></select></td>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
                  <tr align="center" bgcolor="#DDDDDD">
                    <th width="42"  rowspan="3" onClick="doPost()"><img src="../shared/images/refresh.gif" style="cursor:pointer"></th>
                    <th width="90"  rowspan="3">QR Ref</th>
                    <th width="90"  rowspan="3">PO/DI Ref</th>
                    <th width="60"  rowspan="3">WN<br>Date</th>
                    <th width="150" rowspan="3">Grade</th>
                    <th width="180" rowspan="3">Remarks</th>
...
<%
    sc.setFilterMonth();
	sc.inst_type = Const.TYPE_TRUCKING;
	List<WnAllocationEntity> wnas = dao.getWnAllocationDao().getPaging().paging();
	...
	for (int i = 0; i < wnas.size(); i++) {	
		WnAllocationEntity wna = wnas.get(i);
...
%>				
                <tr align="right" onClick="rowClicked(this,<%=qr.getIdLong()%>)" onDblClick="setValue('view',1);doTask();" bgcolor="#FFFFFF">
                  <th width="42" align="right"><%=qr.getIdLong()%>&nbsp;</th>
                  ...
                  <td width="180" align="left"><%=qr.remark%></td>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11" bordercolor="#FFFFFF">
              <tr bgcolor="#DDDDDD" align="right" class="style11" style="font-weight:bold; color:#000000">
                <td width="688" align="center">Estimated Total in %</td>
