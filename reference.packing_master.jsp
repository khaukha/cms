...
<%	
	...
	PackingDAO mdao  = dao.getPackingDao();	
	PackingEntity en = mdao.getById(selected_id); 
...
<table width="100%" border="0" class="style2">
		<tr>
		  ...
		  <td>&nbsp;</td>
		  <td align="" class="style1">PACKING_MASTER</td>
		  <td>&nbsp;</td>
	  </tr>
		<tr>
          ...
          <tr>
            <td align="right">Tare (Kgs)</td>
            <td>&nbsp;</td>
            <td><input name="weight" type="text" id="weight" style="width:80px; text-align:right" value="<%=en.weight%>"></td>
            <td>&nbsp;</td>
          </tr>
          <tr style="display:none">
            <td align="right">Gross (Kgs)</td>
            <td>&nbsp;</td>
            <td><input name="kg_per_bag" type="text" id="kg_per_bag" style="width:80px; text-align:right" value="<%=en.kg_per_bag%>"></td>
            <td>&nbsp;</td>
          </tr>
          <tr style="display:none">
            <td align="right">Bags per pallet</td>
            <td>&nbsp;</td>
            <td><input name="bags_per_pallet" type="text" id="bags_per_pallet" style="width:80px; text-align:right" value="<%=en.bags_per_pallet%>"></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            <td align="right">Description</td>
            <td>&nbsp;</td>
            <td><textarea name="description"  rows="4" style="width:100%" class="style2"><%=en.description%></textarea></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
