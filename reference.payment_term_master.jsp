...
<%	
	...
	PaymentTermDAO mdao  = dao.getPaymentTermDao();
	PaymentTermEntity en = mdao.getById(selected_id); 
...
<table width="100%" border="0" class="style2">
      <tr>
        ...
        <td>&nbsp;</td>
        <td align="" class="style1">PAYMENT_TERM_MASTER</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td class="style1"><input name="short_name" type="text" id="short_name" class="style2"style="width:100%" value="<%=en.short_name%>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="right">Report Term</td>
        <td>&nbsp;</td>
        <td class="style1"><input name="report_term" type="text" id="report_term" class="style2"style="width:100%" value="<%=en.report_term%>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td align="right">Weights</td>
        <td>&nbsp;</td>
        <td><input name="weights" type="text" id="weights" class="style2"style="width:100%" value="<%=en.weights%>"></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
