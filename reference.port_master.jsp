...
<%	
	...
	PortDAO mdao  = dao.getPortDao();	
	PortEntity en = mdao.getById(selected_id); 
...
<table width="100%" border="0" class="style2">
		<tr>
		  ...
		  <td>&nbsp;</td>
		  <td align="" class="style1">PORT_MASTER</td>
		  <td>&nbsp;</td>
	  </tr>
		<tr>
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><select name="country_id" id="country_id"  style="width:100%"><%=Html.selectOptions(dao.getCountryDao().selectAll(),en.country_id,"")%></select></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
