...
<%	
	...
	QualityDiscountDAO mdao  = dao.getQualityDiscountDao();
	QualityDiscountEntity en = mdao.getById(selected_id); 
	QualityDiscountEntity qa = en;
...
%>
    ...
    <table width="100%" border="0" class="style2" cellpadding="0" cellspacing="0">
      <tr valign="top" bgcolor="#DDDDDD">
	  	<th width="150" align="center" class="style1">Value</th>
        <th align="center">Detail (<strong><%=en.getIdInt()%></strong>)</th>
      </tr>
      <tr>
...
<table width="100%" border="0" class="style2">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><%@include file="quality.allowance.jsp"%></td>
            <td>&nbsp;</td>
          </tr>
          <tr>
