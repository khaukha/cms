...
%>	
	<tr onClick="highlightOn(this,1)" align="right" bgcolor="#CCFFFF">
	    ...
	    <td><%=Numeric.getPercent(qr.sc14 + qr.sc15,"")%>&nbsp;</td>
	    <td><%=Numeric.getPercent(qr.sc13,"")%>&nbsp;</td>
...
%>	
	<tr bgcolor="#DDDDDD" style="font-weight:bold; color:#0000FF">
	    ...
	    <td><input name="sc14_in" 			type="text" id="sc14_in" 			class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc14_in,2)%>" 			onChange="dataChanged(this)" <%=_readonly%>></td>
	    <td><input name="sc13_in" 			type="text" id="sc13_in" 			class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc13_in,2)%>" 			onChange="dataChanged(this)" <%=_readonly%>></td>
	  	<td><input name="sc12_in" 			type="text" id="sc12_in" 			class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc12_in,2)%>" 			onChange="dataChanged(this)" <%=_readonly%>></td>
	  	<td><input name="below_sc12_in" 	type="text" id="below_sc12_in" 		class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.below_sc12_in,2)%>" 	onChange="dataChanged(this)" <%=_readonly%>></td>
    </tr>
	<tr bgcolor="#EEEEEE" style="font-weight:bold">
	  ...
	  <td align="right"><%=Numeric.numberToStr(qa.sc14_allow,2)%>&nbsp;</td>
	...
	<tr bgcolor="#DDDDDD" style="font-weight:bold; color:#FF0000">
	  ...
	  <td><input name="sc14_over" 			type="text" id="sc14_over" 			class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc14_over,2)%>" 			onChange="dataChanged(this)" <%=_readonly%>></td>
	  ...
	  <td><input name="sc12_over" 			type="text" id="sc12_over" 			class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc12_over,2)%>" 			onChange="dataChanged(this)" <%=_readonly%>></td>
	  <td><input name="below_sc12_over" 	type="text" id="below_sc12_over" 	class="style1" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.below_sc12_over,2)%>" 		onChange="dataChanged(this)" <%=_readonly%>></td>
    </tr>
	<tr bgcolor="#EEEEEE" style="font-weight:normal">
	  ...
	  <td align="right"><%=Numeric.numberToStr(qa.sc14_discount,0)%>&nbsp;</td>
	...
	<tr bgcolor="#DDDDDD" style="font-weight:bold; color:#FF0000">
	  ...
	  <td><input name="black_broken_discount"	type="text" id="black_broken_discount" 	class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.black_broken_discount,4)%>" 	onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="brown_discount" 			type="text" id="brown_discount" 		class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.brown_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="excelsa_discount" 		type="text" id="excelsa_discount" 		class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.excelsa_discount,4)%>" 		onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="fm_discount" 			type="text" id="fm_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.fm_discount,4)%>" 				onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="moisture_discount" 		type="text" id="moisture_discount" 		class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.moisture_discount,4)%>" 		onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="moldy_discount" 			type="text" id="moldy_discount" 		class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.moldy_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="sc18_discount" 			type="text" id="sc18_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc18_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="sc16_discount" 			type="text" id="sc16_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc16_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="sc14_discount" 			type="text" id="sc14_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc14_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="sc13_discount" 			type="text" id="sc13_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc13_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="sc12_discount" 			type="text" id="sc12_discount" 			class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.sc12_discount,4)%>" 			onChange="dataChanged(this)" <%=readonly%>></td>
	  <td><input name="below_sc12_discount" 	type="text" id="below_sc12_discount" 	class="style2" style="width:100%; text-align:right" value="<%=Numeric.numberToStr(dc.below_sc12_discount,4)%>" 		onChange="dataChanged(this)" <%=readonly%>></td>
    </tr>
</table>			  
