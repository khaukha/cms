...
<%	
	...
	PurchasePriceFixationEntity sfx = dao.getPurchasePriceFixationDao().newEntity();
...
%>	
          <tr align="right">
            ...
            <td align="center"><%=fx.getCurrency().short_name%></td>
            <td><%=Numeric.numberToStr(fx.exchange_rate,0)%>&nbsp;</td>
            <td><%=Numeric.numberToStr(fx.contract_price,2)%>&nbsp;</td>
            <td><%=Numeric.numberToStr(fx.contract_price_local,0)%>&nbsp;</td>
            <td>&nbsp;</td>
          </tr>
<%
	}
%>
          <tr align="right" bgcolor="#DDDDDD">
            ...
            <th align="right"><%=sfx.no_of_lots%>&nbsp;</th>
            <th align="right"><%=Numeric.numberToStr(sfx.tons)%>&nbsp;</th>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
