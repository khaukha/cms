...
%>
  ...
  <tr id="<%=wne.isNull()?"_new_wnr_":""%>" onclick="highlightOn(this);" style="display:<%=wne.isNull()?"none":""%>" title="<%=wne.isNew()?"New WNR":""%>">
    ...
    <td align="center"><input type="text" name="wnr_bags_weight_<%=no%>"   id="wnr_bags_weight_<%=no%>"   class="style11" style="width:50; text-align:right" value="<%=wne.bags_weight%>"  /></td>
    <td align="center"><input type="text" name="wnr_tare_balance_<%=no%>"  id="wnr_tare_balance_<%=no%>"  class="style11" style="width:40; text-align:right" value="<%=wne.tare_balance%>" /></td>
    ...
    <td align="center"><input type="text" name="wnr_tare_weight_<%=no%>"  id="wnr_tare_weight_<%=no%>"  class="style11" style="width:60; text-align:right" value="<%=Numeric.numberToStr(wne.tare_weight,2)%>"  readonly /></td>
    <td align="center"><input type="text" name="wnr_net_weight_<%=no%>"   id="wnr_net_weight_<%=no%>"   class="style11" style="width:60; text-align:right" value="<%=Numeric.numberToStr(wne.net_weight,1)%>"  readonly  /></td>
...
%>
  <tr bgcolor="#DDDDDD">
    ...
    <td align="right"><%=Numeric.numberToStr(sum.tare_balance,1)%>&nbsp;</td>
    <td align="right"><strong><%=Numeric.numberToStr(sum.gross_weight,1)%>&nbsp;</strong></td>
    <td align="right"><strong><%=Numeric.numberToStr(sum.tare_weight,2)%>&nbsp;</strong></td>
