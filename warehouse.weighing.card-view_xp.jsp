<%
	...
	WnExProEntity wnx = (WnExProEntity)wn;

	wnr = weighing.doWeighingWnr(wnx);
    ...
    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style2">
      <tr>
        <td id="wn_" valign="top" width="140px"><table width="100%"  border="0" cellpadding="0" cellspacing="1" class="style11">
          ...
          <tr>
            <td><select name="wn_id" size=16 class="style11" id="wn_id" style="width:140px;" onChange="doPost();"><%=Html.selectOptionsX(dao.getWnExProDao().list(true),sc.wn_id,"Select WN")%></select></td>
          </tr>
          <tr>
            <td>
            ...
            <td><table width="100%"  border="1" cellpadding="0" cellspacing="0" class="style2">
              <tr>
                <td><table id="main_frame_" width="100%"  border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td width="42%" valign="top"><table width="100%"  border="0" cellpadding="1" cellspacing="0" class="style2">
                              ...
                              <tr>
        		                ...
        		                <td><strong><%=DateTime.dateToStr(wn.date)%></strong></td>
                              </tr>
                              <tr>
                            ...
                            <td valign="top"><table width="100%"  border="0" cellpadding="1" cellspacing="0" class="style2">
                              ...
                              <tr id="area_" style="display:">
                                ...
                                <td><select name="area_id" id="area_id" class="style2" style="width:110;"><%=Html.selectOptions(dao.getAreaDao().getByWarehouseId(wid), wn.area_id, "")%></select>&nbsp;&nbsp;<%=wn.getWarehouse().short_name%></td>
                              </tr>
                            </table></td>
                          </tr>
</table></td>
                  ...
                  <tr>
                    <td><%@include file="warehouse.weighing.card-view.wnr-xp.jsp"%></td>
                  </tr>
                  <tr>
                    <td><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="style2">
                  <tr>
                    <td width="150px" align="right">Completed &nbsp;</td>
                    <td width="30"><%=Html.checkBox("status", wn.status)%></td>
