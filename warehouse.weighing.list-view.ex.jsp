          ...
          <tr>
            <td><table width="100%"  border="0" cellpadding="1" cellspacing="1" class="style2">
                <tr align="center" bgcolor="#DDDDDD">
                  ...
                  <th width="110" rowspan="2" id="h22" onClick="doSort(table,'ins_ref_number')">SI Ref</th>
...
%>				
                <tr style="font-size:11px" onClick="highlightOn(this);" onDblClick="wnDblClicked(this,<%=wna.getIdLong()%>,<%=wna.inst_id%>)">
                  ...
                  <td width="140"><%=wna.getInstruction().getContract().getBuyer().short_name%></td>
...
%>				
	...
	<input type="hidden" name="search_key_1"   id="search_key_1"    value="<%=Const.TYPE_SHIPPING%>">
